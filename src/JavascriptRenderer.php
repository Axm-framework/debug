...
use Axm\Debug\DataCollector\AssetProvider;
...
class JavascriptRenderer
{
    ...
    protected $cssVendors = [
        'fontawesome' => PUBLIC_PATH . '/assets/Resources/vendor/font-awesome/css/font-awesome.min.css',
        'highlightjs' => PUBLIC_PATH . '/assets/Resources/vendor/highlightjs/styles/github.css'
    ];

    protected $jsVendors = [
        'jquery'      => PUBLIC_PATH . '/assets/Resources/vendor/jquery/dist/jquery.min.js',
        'highlightjs' => PUBLIC_PATH . '/assets/Resources/vendor/highlightjs/highlight.pack.js'
    ];
    ...
    public function __construct(DebugBar $debugBar, $baseUrl = null, $basePath = null)
    {
        ...
        if ($baseUrl === null) {
            $baseUrl = PUBLIC_PATH . '/assets/Resources/';
        }
